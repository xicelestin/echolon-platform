...
# PAGE: PROFILE
 ...
 with col1:
        annual_revenue = st.number_input("Annual Revenue ($)", min_value=0, step=10000, value=st.session_state.get('profile', {}).get('annual_revenue', 0), key="annual_revenue_input")         with col2:
