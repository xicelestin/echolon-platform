...
# PAGE: PROFILE
 ...
 with col1:
                company_name = st.text_input("Company Name", value=st.session_state.get('profile', {}).get('company_name', ''), key="company_name_input")         industry = st.selectbox("Industry", ["Select an industry...", "SaaS", "E-Commerce", "Professional Services", "Retail", "Healthcare", "Manufacturing", "Finance", "Education", "Other"], key="industry_select")
 with col2:
