...
for idx, insight in enumerate(insights, 1):
            with st.container():
                    ...
                    with col_insight1:
            priority_color = "red" if insight.get("priority", "medium") == "high" else "orange" if insight.get("priority", "medium") == "medium" else "green"                            st.markdown(f"**{insight['icon']} {insight['title']}**")
